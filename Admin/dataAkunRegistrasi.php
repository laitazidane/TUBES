    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="dataAkunRegistrasi.php" class="nav-link active">
          ...
          <section class="col-lg-12 ">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <i class="fas bi bi-person-badge-fill"></i>
                      ...
                      <table class="table table-hover">                        
                        ...
                        <tbody >
                         <tr>
                          ...
                          <td>
                              <a href="editForm.php?id=<?php echo $row["id_admin"]; ?>">
                              <i class="bi bi-pencil" style="color: blue ;"></i>
                              <a href="delete.php?id=<?php echo $row["id_admin"]; ?>">
